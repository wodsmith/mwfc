        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-black border border-gray-800 text-white rounded-lg focus:ring-2 focus:ring-sunrise-gold focus:border-transparent"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-black border border-gray-800 text-white placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-sunrise-gold focus:border-transparent"
            />
          </div>
        </div>
            ...
            >
              ...
              <td className="px-6 py-4">
                <div className="flex items-start gap-4">
                  <div className="hidden sm:flex flex-shrink-0 w-16 h-16 bg-gradient-to-br from-forest-green to-forest-green-light rounded-lg items-center justify-center">
