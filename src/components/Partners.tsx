    ...
    <section id="partners" className="mb-16 relative">
      ...
      <div className="relative z-10">
        ...
        <p className="text-xl text-white text-center pb-16 max-w-3xl mx-auto">
          This competition wouldn't happen without the incredible support of our
          partners. Thank you for helping us bring the Mountain West fitness
          community together!
        </p>

        <div className="space-y-12">
          <div className="text-center">
            <p className="text-lg font-bold text-sunrise-gold mb-6">
              TITLE SPONSOR
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-12 justify-center">
            <div className="text-center">
              <p className="text-lg font-bold text-sunrise-gold mb-6 uppercase">
          ...
          <div>
            <p className="text-lg font-bold text-sunrise-gold text-center mb-8">
              OFFICIAL PARTNERS
            </p>
