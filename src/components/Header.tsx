      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-24 md:py-32 text-center">
          ...
          <h1 className="font-bebas tracking-tight mb-8">
            ...
            <span className="block text-sunrise-gold text-6xl md:text-8xl italic">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              ...
              className="bg-sunrise-gold text-black px-6 py-3 font-bold text-lg rounded hover:bg-sunrise-gold/90 transition-colors min-w-[205px]"
            >
              View Leaderboard
            </Link>
